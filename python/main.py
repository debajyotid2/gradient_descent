...
def main():
    ...
    parser = ArgumentParser(prog="Linear regression using SGD",
                            ...
                            epilog="Please report any bugs by raising an issue at https://github.com/debajyotid2/gradient_descent.git")
    ...
    plt.plot(100 * (np.arange(len(losses_gd))+1), 
             losses_gd, label="GD")
    plt.plot(100 * (np.arange(len(losses_mbsgd))+1), 
